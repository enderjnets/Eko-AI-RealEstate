...
from app.services.enrichment import _coerce, enrich_lead
...
async def test_enrich_lead_happy_path(database_url: str) -> None:
    ...
    payload = ('{"business_type":"Mortgage broker","partner_type":"referral_partner",'
               '"summary":"Local mortgage shop","outreach_angle":"Offer co-marketing","tags":["mortgage","partner"]}')
