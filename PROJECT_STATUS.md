...
4. **Fase 6a, tras el 2.º intento fallido (regla 3).** Motivo: dos intentos
   ...
   `write_text`, que dejó cuatro copias). Diagnóstico mecánico, no de plan.
   Decisión: limpiar por contenido y **persistir antes de insertar**, con
   aserciones de conteo (108 líneas) y de posición relativas al dict ES; el
   tercer intento salió en verde a la primera.
...
Fase 7: móvil medido con Playwright (iPhone 13 + escritorio): sin scroll horizontal, cifra y correo visibles.
