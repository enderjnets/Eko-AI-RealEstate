...
export function Start({ searchParams = {} }: { searchParams?: StartSearchParams }) {
  ...
  return (
    ...
    >
      ...
      <header className="mx-auto flex w-full max-w-7xl items-start justify-between gap-4 px-5 pb-2 pt-[calc(0.75rem+env(safe-area-inset-top,0px))] sm:px-8 sm:pb-4 sm:pt-7 lg:px-12">
        <div className="min-w-0 pt-2">
          ...
          {(LANDING.advisors || LANDING.brokerage) && (
            <p className="mt-1.5 truncate text-[8px] font-medium uppercase tracking-[0.25em] text-ln-body sm:text-[9px]">
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-1 flex-col px-5 pb-9 pt-6 [@media(max-height:700px)]:pt-2 sm:px-8 sm:pb-12 sm:pt-10 lg:px-12 lg:pb-16 lg:pt-14">
        <div className="max-w-3xl">
          <p className="text-[10px] font-medium uppercase tracking-[0.3em] text-ln-bronze">
            {t("start.eyebrow")}
          </p>
          <h1 className="mt-3 max-w-2xl font-ln-serif text-[44px] font-light leading-[0.94] tracking-[-0.025em] text-ln-ink [@media(max-height:700px)]:text-[36px] sm:mt-4 sm:text-[64px] lg:text-[76px]">
            {t("start.title")}
          </h1>
          <p className="mt-3 max-w-xl text-[15px] leading-6 text-ln-body [@media(max-height:700px)]:mt-2 [@media(max-height:700px)]:text-[13px] [@media(max-height:700px)]:leading-5 sm:mt-5 sm:text-[18px] sm:leading-7">
            {t("start.intro")}
          </p>
        </div>
        ...
        >
          <a
            ...
            className="group flex min-h-[160px] flex-col border-r border-t border-ln-line-strong bg-ln-paper p-5 transition-colors hover:bg-ln-cream focus-visible:z-10 [@media(max-height:700px)]:min-h-[112px] [@media(max-height:700px)]:p-3 sm:p-6 lg:min-h-[290px] lg:p-8"
          >
            ...
            <div className="mt-4 grid flex-1 grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] gap-4 [@media(max-height:700px)]:mt-2 lg:mt-9 lg:flex lg:flex-col">
              <h2 className="max-w-xs font-ln-serif text-[27px] font-light leading-[1.02] text-ln-dark [@media(max-height:700px)]:text-[22px] sm:text-[31px] lg:text-[34px]">
                {t("start.buy.title")}
              </h2>
              <div className="flex min-w-0 flex-col">
                <p className="max-w-sm text-[13px] leading-5 text-ln-body [@media(max-height:700px)]:hidden sm:text-[14px] sm:leading-6 lg:mt-4">
                  {t("start.buy.body")}
                </p>
                <span className="mt-3 flex items-center gap-2 text-[10px] font-medium uppercase tracking-[0.22em] text-ln-bronze [@media(max-height:700px)]:mt-1 lg:mt-auto lg:pt-7">
                  {t("start.action")}
          ...
          <a
            ...
            className="group flex min-h-[160px] flex-col border-r border-t border-ln-line-strong bg-ln-stone p-5 transition-colors hover:bg-ln-tint focus-visible:z-10 [@media(max-height:700px)]:min-h-[112px] [@media(max-height:700px)]:p-3 sm:p-6 lg:min-h-[290px] lg:p-8"
          >
            <div className="flex items-start justify-between gap-4">
              <span className="text-[10px] font-medium uppercase tracking-[0.24em] text-ln-dark">
                {t("start.sell.number")}
              </span>
            ...
            <div className="mt-4 grid flex-1 grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] gap-4 [@media(max-height:700px)]:mt-2 lg:mt-9 lg:flex lg:flex-col">
              ...
              <div className="flex min-w-0 flex-col">
                ...
                <span className="mt-3 flex items-center gap-2 text-[10px] font-medium uppercase tracking-[0.22em] text-ln-dark [@media(max-height:700px)]:mt-1 lg:mt-auto lg:pt-7">
                  {t("start.action")}
                  <ArrowUpRight aria-hidden="true" className="h-4 w-4" strokeWidth={1.5} />
                </span>
              </div>
      ...
      <footer className="mx-auto flex w-full max-w-7xl flex-wrap items-center justify-between gap-2 border-t border-ln-line px-5 py-6 text-[10px] uppercase tracking-[0.16em] text-ln-body sm:px-8 lg:px-12">
