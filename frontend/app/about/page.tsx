...
import { Building2, Shield, MessageCircle, CalendarCheck, ArrowRight } from "lucide-react";

// Public-facing landing. Kept as `/about` so `/` can go straight to the dashboard
// for the realtor user. Useful for sharing the product link.
    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-6 py-16">
      <div className="max-w-3xl text-center">
        ...
        <p className="text-lg text-gray-400 mb-10 max-w-xl mx-auto">
          The AI agent that handles your WhatsApp 24/7, captures every lead, schedules visits,
          and follows up — all from your own office hardware. No cloud, no leaks.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
          <Feature
            icon={MessageCircle}
            title="WhatsApp 24/7"
            body="Auto-responds to inbound messages with a local LLM. Never misses a lead."
          />
          <Feature
            icon={CalendarCheck}
            title="Visit booking"
            body="Cal.com / Google Calendar slots offered in chat. Bookings sync back."
          />
          <Feature
            icon={Building2}
