...
export const CHANGELOG: VersionEntry[] = [
  {
    ...
    changes: [
      { en: "A second traffic classifier, for the visits that come from a machine room. Seven of the eight sessions that ever started the contact form were infrastructure: Clonee, Boardman, Prineville, Forest City, Lule\u00e5 and Springfield, 38 to 41 events each and zero scroll, plus Council Bluffs and Ashburn arriving with one event and no referrer. They were all filed as unknown, so every funnel number counted them as people. The rule needs a data-centre city AND zero scroll, and it only ever writes over unknown.", es: "Un segundo clasificador de tr\u00e1fico, para las visitas que vienen de una sala de m\u00e1quinas. Siete de las ocho sesiones que han empezado alguna vez el formulario de contacto eran infraestructura: Clonee, Boardman, Prineville, Forest City, Lule\u00e5 y Springfield, con 38 a 41 eventos cada una y cero scroll, m\u00e1s Council Bluffs y Ashburn llegando con un solo evento y sin referente. Todas quedaban como unknown, as\u00ed que cada n\u00famero del embudo las contaba como personas. La regla exige ciudad de centro de datos Y cero scroll, y solo escribe encima de unknown." },
      ...
      { en: "One rule that was asked for was measured and then NOT implemented: filing any one-event, zero-scroll session as automated. Of the sessions it would have caught, about thirty-three are Denver-area \u2014 Aurora, Denver, Parker, The Pinery, Wheat Ridge \u2014 including eight that arrived inside the Facebook app from the 11-sep share, the best day this site has had. Those are people who landed and left without scrolling, which until v0.108.0 was the reasonable response to a calculator that opened on two empty fields. The metric that matters already excludes them by requiring 50% scroll, so the rule would have cost the diagnosis and bought nothing.", es: "Una regla que se pidi\u00f3 se midi\u00f3 y NO se implement\u00f3: marcar como automated cualquier sesi\u00f3n de un evento y cero scroll. De las sesiones que habr\u00eda capturado, unas treinta y tres son del \u00e1rea de Denver \u2014 Aurora, Denver, Parker, The Pinery, Wheat Ridge \u2014 incluidas ocho que llegaron dentro de la app de Facebook desde el compartido del 11-sep, el mejor d\u00eda que ha tenido esta p\u00e1gina. Son personas que entraron y se fueron sin deslizar, que hasta v0.108.0 era la respuesta razonable a una calculadora que abr\u00eda con dos campos vac\u00edos. La m\u00e9trica que importa ya las excluye al exigir 50% de scroll, as\u00ed que la regla habr\u00eda costado el diagn\u00f3stico sin comprar nada." },
    ],
  },
  {
    version: "0.108.0",
