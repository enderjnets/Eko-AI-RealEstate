...
const EN: Record<string, string> = {
  ...
  "discovery.subtitle": "Find new business leads across Google Maps, Yelp, LinkedIn, and Colorado SOS — or import your existing database from any file.",
  "discovery.searchTitle": "Search for leads",
  "discovery.query": "What kind of business are you looking for?",
  "discovery.queryPlaceholder": "Eg: mortgage brokers, home inspectors, movers…",
  "discovery.city": "City",
...
const ES: Record<string, string> = {
  ...
  "discovery.subtitle": "Encontrá nuevos leads de negocios en Google Maps, Yelp, LinkedIn y Colorado SOS — o importá tu base de datos existente desde cualquier archivo.",
  "discovery.searchTitle": "Buscar leads",
  "discovery.query": "¿Qué tipo de negocio estás buscando?",
  "discovery.queryPlaceholder": "Ej: brokers hipotecarios, inspectores, mudanzas…",
